		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
				<div class="navbar-nav">
					<a class="nav-link" href="listar">Listar</a> <a class="nav-link"
						href="agregar">Agregar</a>
				</div>
			</div>
		</div>
	</nav>
			...
			<div class="mx-auto">
				<div class="card border-0 shadow rounded-3 my-5">
					<div class="card-body p-4">
						<h1 class="text-center mb-5">Modificar Producto</h1>
						<form action="" method="post">
							...
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="text" class="form-control" id="nombreProducto"
										value="${producto.nombreProducto}" name="nombreProducto">
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control" id="precioProducto"
										value="${producto.precioProducto}" name="precioProducto">
								</div>
							</div>
							<div class="row mb-3">
								...
								<div class="col-sm-10">
									<textarea class="form-control" id="descripcionProducto" name="descripcionProducto"
										rows="2">${producto.descripcionProducto}</textarea>
								</div>
							</div>
								...
								<div class="col-sm-10">
									<select class="form-select" aria-label="lista de categorias"
										...
										<c:forEach var="c" items="${listaCategorias}">
											<c:if test="${producto.idCategoria == c.idCategoria}">
												<option selected="selected" 
													value="${c.idCategoria}">${c.nombreCategoria}</option>
											</c:if>
											<c:if test="${producto.idCategoria != c.idCategoria}">
												<option
													value="${c.idCategoria}">${c.nombreCategoria}</option>
							...
							<div class="col-2 mx-auto mt-5">
								<button id="enviar"
									class="btn btn-warning text-uppercase form-control"
